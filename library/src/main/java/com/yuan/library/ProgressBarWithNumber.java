...
public class ProgressBarWithNumber extends View {
    ...
    public ProgressBarWithNumber(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ProgressBarWithNumber);
        reachedColor = typedArray.getColor(R.styleable.ProgressBarWithNumber_reach_Color, Color.BLUE);
        unReachedColor = typedArray.getColor(R.styleable.ProgressBarWithNumber_unReach_Color, Color.RED);
        barHeight = typedArray.getDimension(R.styleable.ProgressBarWithNumber_bar_Height, dp2px(10));
        textSize = typedArray.getDimension(R.styleable.ProgressBarWithNumber_textSize, sp2px(10));
        textColor = typedArray.getColor(R.styleable.ProgressBarWithNumber_textColor, Color.GRAY);
        arc = typedArray.getFloat(R.styleable.ProgressBarWithNumber_arc, arc);
        initPaints();
        typedArray.recycle();
